...
export function HowItWorks() {
  ...
  const renderDesktopStep = (step: (typeof steps)[number], index: number) => (
    <motion.div key={step.number} {...stepMotion(index)} className="text-center group">
      {/* Step Number Circle */}
      <motion.div
  ...
  const renderMobileStep = (step: (typeof steps)[number], index: number) => (
    <motion.div key={step.number} {...stepMotion(index)} className="relative">

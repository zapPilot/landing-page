...
function initHeroAnimations() {
    // Animate chart line continuously
    const chartLine = document.querySelector('.chart-line::before');
...
window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        const heroElements = document.querySelectorAll('.hero-badge, .hero-title .title-line, .hero-subtitle, .hero-cta, .hero-stats');
